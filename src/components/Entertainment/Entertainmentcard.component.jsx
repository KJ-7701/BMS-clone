...
const EntertainmentCard = (props) => {
  return (
    <>
      <div className="w-full h-30 px-2 py-3">
        <img
...
const EntertainmentCardSlider = () => {
  const EntertainmentImage = [
    ...
    "https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:ote-MTUrIEV2ZW50cw%3D%3D,otc-FFFFFF,otf-Roboto,ots-64,ox-48,oy-320,ott-b:w-300:q-80/interactive-games-collection-202012041129.png",
  ];
